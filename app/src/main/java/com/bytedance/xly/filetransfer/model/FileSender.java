...
public class FileSender extends BaseTransfer implements Runnable {
    ...
    public FileSender(Context context, String serverIP, int port, FileInfo fileInfo) {
        mContext = context;
        mServerIP = serverIP;
        mPort = port;
        mFileInfo = fileInfo;
    }
    public FileSender( String serverIP, int port, FileInfo fileInfo) {
        this(null,serverIP,port,fileInfo);
    }
